...
<head>
    ...
    <title>USM HUB | Register Admin</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register.admin.submit') }}">
                                @csrf
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('login.admin') }}">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
